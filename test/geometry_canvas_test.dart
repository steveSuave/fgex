...
void main() {
  group('Auto Point Creation Logic Tests', () {
    ...
    test(
      'should create points automatically when none exist at click location for line',
      () {
        // Initially no points
        ...
        final point1AtPosition = engine.selectPointAt(
          position1.dx,
          position1.dy,
        );
        ...
        final point2AtPosition = engine.selectPointAt(
          position2.dx,
          position2.dy,
        );
    ...
    test(
      'should create points automatically when none exist at click location for circle',
      () {
        // Initially no points
        expect(engine.points.length, equals(0));
        ...
        final centerAtPosition = engine.selectPointAt(
          centerPosition.dx,
          centerPosition.dy,
        );
        ...
        if (centerAtPosition != null) {
          ...
          centerPoint = engine.createFreePoint(
            centerPosition.dx,
            centerPosition.dy,
          );
        }
        ...
        final radiusAtPosition = engine.selectPointAt(
          radiusPosition.dx,
          radiusPosition.dy,
        );
        ...
        if (radiusAtPosition != null) {
          ...
          radiusPoint = engine.createFreePoint(
            radiusPosition.dx,
            radiusPosition.dy,
          );
        }
        ...
        expect(
          circle.getRadius(),
          equals(50.0),
        ); // Distance from (150,150) to (200,150)
      },
    );
    ...
    test(
      'should create new point when clicked outside tolerance of existing points',
      () {
        // Create an existing point
    ...
    test('should handle mixed existing and new points for shape creation', () {
      ...
      final secondPoint = engine.createFreePoint(
        newPosition.dx,
        newPosition.dy,
      );
  ...
  group('Canvas Translation Tests', () {
    ...
    test('should correctly adjust point selection with translation', () {
      ...
      const screenTapPosition = Offset(
        120.0,
        95.0,
