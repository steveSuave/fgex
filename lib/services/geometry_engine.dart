...
class GeometryEngine {
  ...
  GPoint? createIntersectionLL(GLine line1, GLine line2) {
    ...
    // Add constraint
    var constraint = Constraint(ConstraintType.interLL, [intersection, line1, line2]);
  ...
  List<GPoint> createIntersectionLC(GLine line, GCircle circle) {
    ...
    var halfChord = math.sqrt(radius * radius - distanceToLine * distanceToLine);
    ...
    for (var point in intersections) {
      ...
      var constraint = Constraint(ConstraintType.interLC, [point, line, circle]);
      addConstraint(constraint);
    }
